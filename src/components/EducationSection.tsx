...
export const EducationSection = () => {
  const educationItems = [
    {
      degree: "Élève ingénieur en 2ème année, Génie Logiciel",
      school: "École Nationale Supérieure d'Informatique et d'Analyse des Systèmes - ENSIAS",
      location: "Rabat, Maroc",
      period: "2023 – 2026",
      details: "Filière Génie Logiciel (GL). Formation approfondie en développement logiciel, conception d'applications et gestion de projets informatiques.",
      image: "/education/ensias1.png" // Placeholder à remplacer
    },
    {
      ...
      period: "2021-2023",
      details: "Option Mathématiques Physiques (MP). Formation intensive en mathématiques et physique préparant aux concours des grandes écoles d'ingénieurs.",
      image: "/education/cpge.jpg" // Placeholder à remplacer
    }
  ];
