...
const RealGithubContributions: React.FC<GithubContributionsProps> = ({  
  ...
  const monthLabels = getMonthLabelsForWeeks();  
    ...
    <div className="bg-white p-6 rounded-lg border shadow-sm">  
      ...
      <div className="flex flex-col items-center">  
        {!isMobile ? (  
          ...
          // Vue Mobile (verticale fusionnée)    
<div className="w-full overflow-x-auto flex justify-center">  
  <div className="inline-block">  
    <div className="flex gap-1">  
      {/* Espace pour les labels de mois */}  
      <div className="w-10"></div>  
        
      {/* Labels des jours - UNE SEULE FOIS en haut, centrés */}    
      <div className="flex gap-1 mb-2 text-xs text-gray-500">    
        <div style={{ width: "11px", textAlign: "center" }}>L</div>    
        <div style={{ width: "11px", textAlign: "center" }}>M</div>    
        <div style={{ width: "11px", textAlign: "center" }}>M</div>    
        <div style={{ width: "11px", textAlign: "center" }}>J</div>    
        <div style={{ width: "11px", textAlign: "center" }}>V</div>    
        <div style={{ width: "11px", textAlign: "center" }}>S</div>    
        <div style={{ width: "11px", textAlign: "center" }}>D</div>    
      </div>  
    </div>  
  
    {/* Toutes les semaines fusionnées */}    
    <div className="flex flex-col gap-1">    
      {contributions.map((week, weekIndex) => {    
        const monthLabel = monthLabels.find(m => m.weekIndex === weekIndex);    
        return (    
          <div key={weekIndex} className="flex gap-1 items-center">    
            <div className="text-xs text-gray-500 w-10 text-right pr-2">    
              {monthLabel ? monthLabel.label : ""}    
            </div>    
            <div className="flex gap-1">    
              {week.contributionDays.map((day, dayIndex) => {    
